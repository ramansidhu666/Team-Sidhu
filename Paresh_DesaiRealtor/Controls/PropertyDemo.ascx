 ...
 <script>
     ...
     $(document).ready(function () {
         $("#shareBtn").click(function () {
             ...
             var URL = 'http://teamsidhugta.com//PropertyDetails.aspx?MLSID=' + MLSID + '&PropertyType=' + PropertyType;
            ...
            <div class="col-md-12 col-sm-12">
              ...
              <img src="../images/arshad.png" alt="" />
                        ...
                        <div class="roco_pro_info">
                            <h2>
                            <asp:Label ID="lblname"  runat="server"></asp:Label>Team Sidhu</h2>
                            <p>Sales Representative</p>
                            <asp:Label CssClass="email_profile_r" ID="lblemail" runat="server"></asp:Label>
                            <span class="email_profile_r">416-317-8283, 647-407-4348</span>
                        </div>
                    </div>
